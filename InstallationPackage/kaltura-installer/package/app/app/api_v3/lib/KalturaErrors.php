...
class KalturaErrors extends APIErrors
{
	 ...
	 * Wams credentials
	 */
	const WAMS_CREDENTIALS_REQUIRED = 'WAMS_CREDENTIALS_REQUIRED,Microsoft Azure Media services account name or account key is empty';
	const WAMS_CREDENTIALS_ERROR = 'WAMS_CREDENTIALS_ERROR,Microsoft Azure Media services authentication failed';
