...
//--------------------------- General Information ---------------------------			
		...
		$this->addElement('text', 'wams_account_name', array(
			'label'			=> 'partner-configure WAMS Account Name',
			'filters'		=> array('StringTrim'),
			'ignore' 		=> true,
		));

		$this->addElement('text', 'wams_account_key', array(
			'label'			=> 'partner-configure WAMS Account Key',
			'filters'		=> array('StringTrim'),
			'ignore' 		=> true,
		));
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------		
	...
	public function addAllDisplayGroups($permissionNames)
	{
		...
		$this->addDisplayGroup(array('partner_name', 'description','admin_name', 'admin_email', 'id', 'kmc_version', 'wams_account_name', 'wams_account_key', 'crossLine'), 'generalInformation', array('legend' => 'General Information'));
		...
		//$this->addDisplayGroup(array('api_access_control_id', 'crossLine'), 'apiAccessControlIdGroup', array('legend' => 'Access Control'));
