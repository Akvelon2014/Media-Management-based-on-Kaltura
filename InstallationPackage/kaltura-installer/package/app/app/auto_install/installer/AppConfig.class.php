...
class AppConfig {
	...
	private function defineInstallationTokens() {
		...
		$this->app_config['EVENTS_WILDCARD'] = $this->app_config['KALTURA_FULL_VIRTUAL_HOST_NAME']. '-kaltura_apache_access.log-.*';
		...
		$this->app_config['QUICK_START_GUIDE_URL'] = 'http://'.$this->app_config['KALTURA_VIRTUAL_HOST_NAME'].'/content/docs/wams/kmc.html';
