...
abstract class BasePartnerPeer {
	...
	/** the column name for the WAMS_ACCOUNT_NAME field */
	const WAMS_ACCOUNT_NAME = 'partner.WAMS_ACCOUNT_NAME';

	/** the column name for the WAMS_ACCOUNT_KEY field */
	const WAMS_ACCOUNT_KEY = 'partner.WAMS_ACCOUNT_KEY';
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(PartnerPeer::WAMS_ACCOUNT_NAME);
		$criteria->addSelectColumn(PartnerPeer::WAMS_ACCOUNT_KEY);
	}
