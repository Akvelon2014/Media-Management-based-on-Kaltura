...
abstract class BasePartner extends BaseObject  implements Persistent {
	...
	protected $kmc_version;
        ...
        /**
	 * The value for the wams_account_name field.
	 * Note: this column has a database default value of: null
	 * @var        string
	 */
	protected $wams_account_name;
        
        /**
	 * The value for the wams_account_key field.
	 * Note: this column has a database default value of: null
	 * @var        string
	 */
	protected $wams_account_key;
	...
	public function applyDefaultValues()
	{
		...
		$this->kmc_version = '1';
                $this->wams_account_name = null;
                $this->wams_account_key = null;
	}
	...
	public function getKmcVersion()
	{
        ...
        /**
	 * Get the [wams_account_name] column value.
	 * 
	 * @return     string
	 */
	public function getWamsAccountName()
	{
		return $this->wams_account_name;
	}
        
        /**
	 * Get the [wams_account_key] column value.
	 * 
	 * @return     string
	 */
	public function getWamsAccountKey()
	{
		return $this->wams_account_key;
	}
	...
	public function setKmcVersion($v)
	{
        ...
        /**
	 * Set the value of [wams_account_name] column.
	 * 
	 * @param      string $v new value
	 * @return     Partner The current object (for fluent API support)
	 */
	public function setWamsAccountName($v)
	{
		if(!isset($this->oldColumnsValues[PartnerPeer::WAMS_ACCOUNT_NAME]))
			$this->oldColumnsValues[PartnerPeer::WAMS_ACCOUNT_NAME] = $this->wams_account_name;

		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->wams_account_name !== $v || $this->isNew()) {
			$this->wams_account_name = $v;
			$this->modifiedColumns[] = PartnerPeer::WAMS_ACCOUNT_NAME;
		}
        ...
        /**
	 * Set the value of [wams_account_key] column.
	 * 
	 * @param      string $v new value
	 * @return     Partner The current object (for fluent API support)
	 */
	public function setWamsAccountKey($v)
	{
		if(!isset($this->oldColumnsValues[PartnerPeer::WAMS_ACCOUNT_KEY]))
			$this->oldColumnsValues[PartnerPeer::WAMS_ACCOUNT_KEY] = $this->wams_account_key;

		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->wams_account_key !== $v || $this->isNew()) {
			$this->wams_account_key = $v;
			$this->modifiedColumns[] = PartnerPeer::WAMS_ACCOUNT_KEY;
		}
	...
	public function hasOnlyDefaultValues()
	{
			...
			if ($this->kmc_version !== '1') {
				return false;
                        ...
                        if ($this->wams_account_name !== null) {
                                return false;
                        }
                        
                        if ($this->wams_account_key !== null) {
                                return false;
                        }
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->kmc_version = ($row[$startcol + 40] !== null) ? (string) $row[$startcol + 40] : null;
                        $this->wams_account_name = ($row[$startcol + 41] !== null) ? (string) $row[$startcol + 41] : null;
                        $this->wams_account_key = ($row[$startcol + 42] !== null) ? (string) $row[$startcol + 42] : null;
			$this->resetModified();
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					$affectedObjects = PartnerPeer::doUpdate($this, $con);
					if($affectedObjects)
						$this->objectSaved = true;
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 40:
				...
				break;
			case 41:
				return $this->getWamsAccountName();
				break;
			case 42:
				return $this->getWamsAccountKey();
				break;
			default:
				return null;
				break;
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[41] => $this->getWamsAccountName(),
			$keys[42] => $this->getWamsAccountKey(),
		);
		return $result;
	}
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 40:
				...
				break;
			case 41:
				$this->setWamsAccountName($value);
				break;
			case 42:
				$this->setWamsAccountKey($value);
				break;
		} // switch()
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[41], $arr)) $this->setWamsAccountName($arr[$keys[41]]);
		if (array_key_exists($keys[42], $arr)) $this->setWamsAccountKey($arr[$keys[42]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PartnerPeer::KMC_VERSION)) $criteria->add(PartnerPeer::KMC_VERSION, $this->kmc_version);
                if ($this->isColumnModified(PartnerPeer::WAMS_ACCOUNT_NAME)) $criteria->add(PartnerPeer::WAMS_ACCOUNT_NAME, $this->wams_account_name);
                if ($this->isColumnModified(PartnerPeer::WAMS_ACCOUNT_KEY)) $criteria->add(PartnerPeer::WAMS_ACCOUNT_KEY, $this->wams_account_key);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setKmcVersion($this->kmc_version);
                ...
                $copyObj->setWamsAccountName($this->wams_account_name);
                
                $copyObj->setWamsAccountKey($this->wams_account_key);
