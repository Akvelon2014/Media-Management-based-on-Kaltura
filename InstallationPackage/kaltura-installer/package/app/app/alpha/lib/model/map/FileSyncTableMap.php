...
class FileSyncTableMap extends TableMap {
	 ...
	 */
	const CLASS_NAME = 'Core.FileSyncTableMap';
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('WAMS_ASSET_ID', 'WamsAssetId', 'VARCHAR', false, 255, null);
		$this->addColumn('WAMS_URL', 'WamsURL', 'VARCHAR', false, 2048, null);
		// validators
	} // initialize()
