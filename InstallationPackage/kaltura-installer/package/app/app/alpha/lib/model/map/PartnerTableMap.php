...
class PartnerTableMap extends TableMap {
	 ...
	 */
	const CLASS_NAME = 'Core.PartnerTableMap';
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('WAMS_ACCOUNT_NAME', 'WamsAccountName', 'VARCHAR', false, 100, null);
		$this->addColumn('WAMS_ACCOUNT_KEY', 'WamsAccountKey', 'VARCHAR', false, 100, null);
		// validators
	} // initialize()
