...
{     
	...
	{
		public static const CONTENT_PAGE_VIEW : String = "Page view/";   // V
		public static const CONTENT_ADD_PLAYLIST : String = "Add  Manual Playlist";  // V
		public static const CONTENT_ADD_RULEBASED_PLAYLIST : String = "Add RuleBased Playlist";  // V
		public static const CONTENT_EDIT_PLAYLIST : String = "Content Edit Playlist";  // V 
		public static const CONTENT_DELETE_PLAYLIST : String = "Content Delete Playlist"; // V
		public static const CONTENT_DELETE_ITEM : String = "Content Delete Entry"; // V
		public static const CONTENT_DELETE_MIX : String = "Content Delete Mix"; // V
		public static const CONTENT_EDIT_ENTRY : String = "Content Edited DrillDown";   // V
		public static const CONTENT_ENTRY_DRILLDOWN : String = "Content Entry DrillDown";   // V
		public static const CONTENT_ACCESS_CONTROL : String = "Content Set Access Control";   // V
		public static const CONTENT_SET_SCHEDULING : String = "Content Set Scheduling";   // V
		public static const CONTENT_CHANGE_THUMBNAIL : String = "Content Change Thumbnail"; // V
		public static const CONTENT_ADD_TAGS : String = "Add tags";    // V
		public static const CONTENT_REMOVE_TAGS : String = "Content Remove Tags";  // V 
		public static const CONTENT_ADD_ADMIN_TAGS : String = "Content Add Admin tags";  // V
		public static const CONTENT_REMOVE_ADMIN_TAGS : String = "Remove tags"; // V 
		public static const CONTENT_DOWNLOAD : String = "Download";   // V
		...
		public static const CONTENT_GO_TO_PAGE_NUM : String = "Go To Page Number/Page";  // V
		public static const CONTENT_OPEN_PREVIEW_AND_EMBED : String = "Content/Open Preview and Embed";  // V
		
		public static const CONTENT_FIRST_TIME_PLAYLIST_EMBED: String = "content first time playlist embed";  // V
		public static const CONTENT_FIRST_TIME_PLAYER_EMBED: String = "content first time player embed";  // V
		public static const CONTENT_FIRST_TIME_PLAYLIST_CREATION: String = "content first time playlist creation";  // V
