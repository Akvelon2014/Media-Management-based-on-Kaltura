...
package com.kaltura.vo
{
	...
	public dynamic class KalturaPartner extends BaseFlexVo
	{
		...
		/**
		 * Field for wams account name. Must be not empty.
		 **/
		public var wamsAccountName : String = null;
		
		/**
		 * Field for wams account key. Must be not empty.
		 **/
		public var wamsAccountKey : String = null;
		...
		public function getUpdateableParamKeys():Array
		{
			...
			arr.push('country');
			arr.push('state');
			arr.push('wamsAccountName');
			arr.push('wamsAccountKey');
			return arr;
		}
